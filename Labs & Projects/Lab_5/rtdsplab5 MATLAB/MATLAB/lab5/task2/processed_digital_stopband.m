...
%add horizontal line (boundaries)
SB = -23; %stopband attenuation
plot ([0:1000: 4000],[SB SB SB SB SB]);
hold on;
...
xlabel('frequency(Hz)');
ylabel('magitude(dB)');
legend('processed output','stop band attenuation','ideal digital filter');